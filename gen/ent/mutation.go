...
func (m *WordMutation) ClearName() {
	m.name = nil
	m.clearedFields[word.FieldName] = struct{}{}
}

// NameCleared returns if the "name" field was cleared in this mutation.
func (m *WordMutation) NameCleared() bool {
	_, ok := m.clearedFields[word.FieldName]
	return ok
}
...
func (m *WordMutation) ResetName() {
	m.name = nil
	delete(m.clearedFields, word.FieldName)
}
...
func (m *WordMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(word.FieldName) {
		fields = append(fields, word.FieldName)
	}
	return fields
}
